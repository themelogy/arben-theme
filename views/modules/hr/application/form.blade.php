                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label :for="'speak.better'+key" class="radio-inline">
                                                                                    <input type="radio" :id="'speak.better'+key" value="3"
                                                                                           v-model="lang.speak"/>
                                                                                    {{ trans('hr::applications.select.language.radio.better') }}</label>
                                                                                    <label :for="'speak.middle'+key" class="radio-inline">
                                                                                    <input type="radio" :id="'speak.middle'+key" value="2"
                                                                                           v-model="lang.speak"/>
                                                                                    {{ trans('hr::applications.select.language.radio.middle') }}</label>
                                                                                    <label :for="'speak.little'+key" class="radio-inline">
                                                                                    <input type="radio" :id="'speak.little'+key" value="1"
                                                                                           v-model="lang.speak"/>
                                                                                    {{ trans('hr::applications.select.language.radio.little') }}</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <label v-if="key == 0">{{ trans('hr::applications.select.language.read') }}</label>
                                                                                <div class="form-group">
                                                                                    <label :for="'read.better'+key" class="radio-inline">
                                                                                    <input type="radio" :id="'read.better'+key" value="3"
                                                                                           v-model="lang.read"/>
                                                                                    {{ trans('hr::applications.select.language.radio.better') }}</label>

                                                                                    <label :for="'read.middle'+key" class="radio-inline">
                                                                                    <input type="radio" :id="'read.middle'+key" value="2"
                                                                                           v-model="lang.read"/>
                                                                                    {{ trans('hr::applications.select.language.radio.middle') }}</label>

                                                                                    <label :for="'read.little'+key" class="radio-inline">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <div class="group">
                                                                                    <label :for="'write.better'+key" class="radio-inline">
                                                                                    <input type="radio" :id="'write.better'+key" value="3"
                                                                                           v-model="lang.write"/>
                                                                                    {{ trans('hr::applications.select.language.radio.better') }}</label>
                                                                                    <label :for="'write.middle'+key" class="radio-inline">
                                                                                    <input type="radio" :id="'write.middle'+key" value="2"
                                                                                           v-model="lang.write"/>
                                                                                   {{ trans('hr::applications.select.language.radio.middle') }}</label>
                                                                                    <label :for="'write.little'+key" class="radio-inline">
                                    ...
                                    <input id="attachment" type="file" name="attachment" @change="onFileChange" />
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 m-top-20">
                                                        {!! Form::submit(trans('hr::applications.buttons.create'), ['class'=>'btn btn-default btn btn-bordered', 'v-bind:value'=>'button']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
