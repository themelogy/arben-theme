<?php
namespace Themes\Arben\Presenter;

use Nwidart\Menus\Presenters\Presenter;

class HeaderSmartMenuPresenter extends Presenter
{
    /**
     * {@inheritdoc }.
     */
    ...
    {
        $link = '<li'.$this->getActiveState($item).'><a'.$this->getActiveState($item).' href="'.$item->getUrl().'" '.$item->getAttributes().'>';
